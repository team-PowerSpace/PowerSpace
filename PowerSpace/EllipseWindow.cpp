...
// ќтрисовка эллипса в целевом контексте с центром в координате (x, y). Ёллипс имеет радиус, указанный в параметре r класса.
...
// ќконна€ процедура. ќбработка сообщений, приход€щих в окно.
